...
android {
    ...
    namespace = "com.avafli.avaflisdk"
    compileSdk = 35
        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/AVAFLI/avafli_android_sdk")
                    ...
                    scm {
                        connection.set("scm:git:github.com/AVAFLI/avafli_android_sdk.git")
                        developerConnection.set("scm:git:ssh://github.com/AVAFLI/avafli_android_sdk.git")
                        url.set("https://github.com/AVAFLI/avafli_android_sdk/tree/main")
                    }
                }
            }
        }
