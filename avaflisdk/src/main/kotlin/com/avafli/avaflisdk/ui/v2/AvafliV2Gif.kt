...
// reveal beat, ported from iOS AvafliV2GifView/AvafliV2GifAsset. Playback is Coil-free:
 ...
 */
internal object AvafliV2GifAssets {
    ...
    suspend fun prewarm(context: Context) {
        ...
        withContext(Dispatchers.IO) {
            load(appContext, R.raw.avafli_confetti_burst)
        }
    }
...
private fun GifBurstApi28(
    ...
    var drawable by remember(resId) { mutableStateOf(AvafliV2GifAssets.cached(resId)) }
    ...
    LaunchedEffect(resId) {
        if (drawable == null) {
            val loaded = withContext(Dispatchers.IO) { AvafliV2GifAssets.load(context, resId) }
