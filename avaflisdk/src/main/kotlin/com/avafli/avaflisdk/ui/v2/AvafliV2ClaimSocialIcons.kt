...
internal enum class AvafliSocialGlyphKind(val displayName: String, val utmSource: String) {
...
@Composable
internal fun AvafliSocialGlyph(kind: AvafliSocialGlyphKind, modifier: Modifier = Modifier) {
    Box(modifier, contentAlignment = Alignment.Center) {
        Image(
            imageVector = when (kind) {
                AvafliSocialGlyphKind.Instagram -> InstagramIcon
                AvafliSocialGlyphKind.Facebook -> FacebookIcon
                AvafliSocialGlyphKind.X -> XIcon
                AvafliSocialGlyphKind.Snapchat -> SnapchatIcon
                AvafliSocialGlyphKind.TikTok -> TikTokIcon
            },
...
/** Builds a white-filled 48×48 [ImageVector] from Figma-exported SVG path data. */
private fun avafliBrandIcon(name: String, vararg pathData: String): ImageVector {
...
// Path data is verbatim from the official brand SVGs (icon-x / icon-facebook /
// icon-instagram / icon-snapchat / icon-tiktok); do not hand-edit.

private val InstagramIcon: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    avafliBrandIcon(
        "AvafliInstagram",
...
private val FacebookIcon: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    avafliBrandIcon(
        "AvafliFacebook",
...
private val XIcon: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    avafliBrandIcon(
        "AvafliX",
...
private val SnapchatIcon: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    avafliBrandIcon(
        "AvafliSnapchat",
...
private val TikTokIcon: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    avafliBrandIcon(
        "AvafliTikTok",
 ...
 */
internal object AvafliShareSheet {
    ...
    fun share(context: Context, kind: AvafliSocialGlyphKind, text: String, shareUrl: String?) {
        ...
        when (kind) {
            ...
            AvafliSocialGlyphKind.Instagram,
            AvafliSocialGlyphKind.Snapchat,
            AvafliSocialGlyphKind.TikTok -> present(context, textWithLink)
        }
    }
