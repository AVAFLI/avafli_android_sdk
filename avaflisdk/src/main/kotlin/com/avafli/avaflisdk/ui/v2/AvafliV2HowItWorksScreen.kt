...
// How-it-works screen, ported from iOS AvafliV2HowItWorksView. The header swaps
...
// confirmation at the V2 root (AvafliV2OptOutConfirmDialog).

@Composable
internal fun AvafliV2HowItWorksScreen(
    accent: Color,
    logoUrl: String?,
    day1Entries: Int,
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            .background(AvafliV2Color.panel),
        ...
        Box(
            ...
            Text(
                "HOW IT WORKS",
                style = AvafliV2Font.inter(26.sp, FontWeight.Black, tracking = (-0.78).sp, color = AvafliV2Color.gunmetal),
            )
        }
...
private fun HowItWorksItem(number: String, title: String, body: String) {
    Row(horizontalArrangement = Arrangement.spacedBy(9.dp)) {
        Text(
            "$number.",
            style = AvafliV2Font.inter(18.sp, FontWeight.Black, color = Color.White),
        )
