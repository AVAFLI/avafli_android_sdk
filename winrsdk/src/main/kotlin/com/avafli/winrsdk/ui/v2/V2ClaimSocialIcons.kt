    ...
    Box(modifier, contentAlignment = Alignment.Center) {
        Image(
            imageVector = when (kind) {
                WINRSocialGlyphKind.Instagram -> InstagramIcon
                WINRSocialGlyphKind.Facebook -> FacebookIcon
                WINRSocialGlyphKind.X -> XIcon
                WINRSocialGlyphKind.Snapchat -> SnapchatIcon
                WINRSocialGlyphKind.TikTok -> TikTokIcon
            },
...
private fun winrBrandIcon(name: String, vararg pathData: String): ImageVector {
